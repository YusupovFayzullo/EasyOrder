...
//            value = "select * from tables  where is not is_deleted;",
...
//    Page<Table> getAll(Pageable pageable);
    ...
    @Query("""
            select new uz.tafakkoor.easyorder.dtos.restaurant.NotBookedTableDto(t.number,t.capacity,r.name,r.address.city,r.address.street,r.address.house,r.phoneNumber,r.openTime,r.closeTime) from Table  t inner join Restaurant  r
